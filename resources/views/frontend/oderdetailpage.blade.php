...
<section class="payment-page py-12 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <!-- Payment Info Section -->
        <div class="payment__info">
            <header class="title mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Complete Your Payment</h1>
                <span class="text-sm text-gray-600">Order #12345</span>
            </header>

            <!-- Order Summary -->
            <section class="order-summary mb-6">
                <h2 class="text-lg font-semibold text-gray-800">Order Summary:</h2>
                <ul class="list-none pl-0">
                    <li class="text-gray-700 mb-2">
                        <strong>Product Name 1</strong> - &euro;99.00 x 2 = &euro;198.00
                    </li>
                    <li class="text-gray-700 mb-2">
                        <strong>Product Name 2</strong> - &euro;50.00 x 2 = &euro;100.00
                    </li>
                </ul>
                <p class="text-gray-800 font-semibold mt-4">Total: &euro;299.00</p>
            </section>
...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Buy me a beer" href="https://www.buymeacoffee.com/scottwindon" target="_blank" class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            ...
            <!-- Contact Information -->
            <footer class="contact-info mt-6">
                <p class="text-sm text-gray-500">Have questions? <a href="mailto:support@example.com" class="text-blue-500 underline">Contact Support</a></p>
            </footer>
        </div>

        <!-- Order Product Photo Section -->
        <aside class="order__photo">
            <figure class="photo-container">
                <img src="/assets/image/product1.jpeg" alt="Ordered Product" class="w-full h-[500px] object-cover rounded-lg shadow-lg">
            </figure>
        </aside>
    </div>

    <!-- Security Notice -->
    <div class="security-notice mt-12 text-center">
        <p class="text-gray-600 text-sm">Your payment information is securely encrypted. We do not store your card details.</p>
    </div>
</section>

<!-- JavaScript for Payment Method Behavior -->
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        paymentMethodSelect.addEventListener('change', () => {
            if (paymentMethodSelect.value === 'credit_card') {
                ...
                cardDetails.querySelectorAll('input').forEach(input => input.removeAttribute('disabled'));
            } else {
                cardDetails.style.display = 'none';
                cardDetails.querySelectorAll('input').forEach(input => input.setAttribute('disabled', true));
            }
        });
